package com.example.jackson_demo.service.tutorServices;
...
@Service
@Slf4j
public class TutorServiceJackson {
    ...
    public Car createFromFile() throws IOException {
        ObjectMapper objectMapper = new ObjectMapper();
        File file = new File("D:\\0 - Java\\trash\\jackson_demo\\src\\main\\resources\\tutorJson\\car.json");
    ...
    public Car createFromUrl() throws IOException {
        ObjectMapper objectMapper = new ObjectMapper();
        URL url = new URL("file:D:\\0 - Java\\trash\\jackson_demo\\src\\main\\resources\\tutorJson\\car.json");
    ...
    public Car createfromInputStream() throws IOException {
        ObjectMapper objectMapper = new ObjectMapper();
        InputStream input = new FileInputStream("D:\\0 - Java\\trash\\jackson_demo\\src\\main\\resources\\tutorJson\\car.json");
    ...
    public String writeJsonFromObjectToFile() throws IOException{
        ...
        car.setBrand("Matiz");
        car.setDoors(1);
        objectMapper.writeValue(new FileOutputStream("D:\\0 - Java\\trash\\jackson_demo\\src\\main\\resources\\tutorJson\\write.json"), car);
    ...
    public String jsonGenerator() throws IOException{
        ...
        JsonFactory factory = new JsonFactory();
        JsonGenerator generator = factory.createGenerator(new File("D:\\0 - Java\\trash\\jackson_demo\\src\\main\\resources\\tutorJson\\generator.json"), JsonEncoding.UTF8);
